export default {
  ...
  sosimple: 'so simple',
  onboarding1_1: 'the easiest way to',
  onboarding1_2: 'invest in bitcoin',
  onboarding2_1: 'no account',
  onboarding2_2: 'no registration',
  onboarding2_3: 'no deposit',
  autoinvest: 'auto invest',
  onboarding3_1: 'automate recurring ',
  onboarding3_2: 'investments from 10 CHF',
  ...
  restoreiban: 'which IBAN did you use Relai with',
  restorebtc: 'enter your 12 words (seed)',
  restorebtcwarning:
